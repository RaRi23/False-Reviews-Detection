...
class Ui_signUp(object):
    ...
    def info(self):
        ...
        msg.setText("User registration successfully completed")
    ...
    def setupUi(self, Dialog):
        ...
        Dialog.resize(1250, 740)
        Dialog.setStyleSheet(_fromUtf8("background-image: url(III2.jpg); border: 2px solid orange"))
        # Dialog.setStyleSheet(_fromUtf8("border: 2px solid black"))

        #############################################################################

        self.label = QtWidgets.QLabel(Dialog)
        self.label.setGeometry(QtCore.QRect(500, 100, 150, 25))
        ...
        self.label_2.setGeometry(QtCore.QRect(500, 150, 150, 25))
        ...
        self.label_M.setGeometry(QtCore.QRect(500, 200, 150, 25))
        ...
        self.label_3.setGeometry(QtCore.QRect(500, 250, 150, 25))
        ...
        self.uname_lineEdit.setGeometry(QtCore.QRect(665, 100, 211, 27))
        ...
        self.signup_btn.setGeometry(QtCore.QRect(550, 300, 280, 25))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(60)
        ...
        self.exit.setGeometry(QtCore.QRect(550, 350, 280, 25))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(60)
    ...
    def closeall(self):
        ...
        #quit()
        from login import Ui_Dialog as LUi_Dialog
    ...
    def retranslateUi(self, Dialog):
        ...
        self.exit.setText(_translate("Dialog", "Go to Login", None))
