...
class Ui_Dialog(object):
    ...
    def info(self):
        ...
        msg.setText("Please enter correct username and password ... !")
        msg.setWindowTitle("ERROR (User & Password)")
    ...
    def setinUi(self, Dialog):
        ...
        Dialog.resize(1280, 750)
        Dialog.setStyleSheet(_fromUtf8("background-image: url(login1.jpg); border: 2px solid blue"))
